          ...
          <div className="order-2 lg:order-1">
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                <div className="bg-tijwal-blue/10 rounded-full p-3 h-12 w-12 flex items-center justify-center flex-shrink-0">
                  <Eye className="h-6 w-6 text-tijwal-blue" />
                </div>
                <div>
              ...
              <div className="flex gap-4">
                <div className="bg-tijwal-blue/10 rounded-full p-3 h-12 w-12 flex items-center justify-center flex-shrink-0">
                  <Clock className="h-6 w-6 text-tijwal-blue" />
                </div>
                <div>
              ...
              <div className="flex gap-4">
                <div className="bg-tijwal-blue/10 rounded-full p-3 h-12 w-12 flex items-center justify-center flex-shrink-0">
                  <Users className="h-6 w-6 text-tijwal-blue" />
                </div>
                <div>
              ...
              <div className="flex gap-4">
                <div className="bg-tijwal-blue/10 rounded-full p-3 h-12 w-12 flex items-center justify-center flex-shrink-0">
                  <BarChart3 className="h-6 w-6 text-tijwal-blue" />
                </div>
                <div>
          ...
          <div className="order-1 lg:order-2">
            <div className="relative">
              <div className="relative glass-card p-1 rounded-2xl shadow-xl transform transition-all duration-500 hover:scale-[1.02]">
                {/* This would be replaced with an actual image or video of Tijwal Eye Technology */}
                <div className="bg-tijwal-blue/5 h-80 sm:h-96 rounded-xl flex items-center justify-center overflow-hidden relative">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-40 h-40 rounded-full bg-tijwal-blue/20 animate-pulse flex items-center justify-center">
                      <div className="w-32 h-32 rounded-full bg-tijwal-blue/30 flex items-center justify-center">
                        <div className="w-24 h-24 rounded-full bg-tijwal-blue/40 flex items-center justify-center">
                          <Eye className="h-12 w-12 text-tijwal-blue" />
                        </div>
                      </div>
                    </div>
                  </div>
                  {/* Animated elements */}
                  <div className="absolute top-1/4 left-1/4 w-3 h-3 bg-tijwal-blue rounded-full animate-ping opacity-75"></div>
                  <div className="absolute top-3/4 right-1/3 w-2 h-2 bg-tijwal-orange rounded-full animate-ping opacity-75"></div>
