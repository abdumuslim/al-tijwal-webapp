  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-tijwal-light via-white to-tijwal-light overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-1/3 -right-20 w-80 h-80 bg-tijwal-blue/10 rounded-full blur-3xl animate-pulse-soft"></div>
        <div className="absolute bottom-1/4 -left-20 w-96 h-96 bg-tijwal-orange/10 rounded-full blur-3xl animate-pulse-soft"></div>
      ...
      <div className="container mx-auto px-4 z-10 text-center py-20">
        <div className="inline-block mb-6 animate-fade-in-right">
          <span className="bg-tijwal-blue/10 text-tijwal-blue px-4 py-1 rounded-full text-sm font-medium">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto mt-12 animate-fade-in">
          <div className="glass-card p-6">
            <h3 className="text-tijwal-blue text-3xl font-bold mb-2">+5000</h3>
            <p className="text-tijwal-gray">مشاهدة يومية</p>
          </div>
          <div className="glass-card p-6">
            <h3 className="text-tijwal-blue text-3xl font-bold mb-2">+40</h3>
            <p className="text-tijwal-gray">موقع استراتيجي</p>
          </div>
          <div className="glass-card p-6">
            <h3 className="text-tijwal-blue text-3xl font-bold mb-2">+95%</h3>
        ...
        >
          <ChevronDown className="h-10 w-10 text-tijwal-blue opacity-80" />
        </div>
      </div>
    </section>
  );
