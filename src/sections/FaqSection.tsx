  ...
  const faqs: FaqItem[] = [
    {
      ...
      answer: "عين التجوال هي تقنية ذكاء اصطناعي متطورة تقيس عدد المشاهدات ومدة المشاهدة لإعلاناتك على شاشاتنا المتنقلة. تستخدم خوارزميات متقدمة لتحليل البيانات وتوفير معلومات دقيقة عن أداء حملتك الإعلانية، مع الحفاظ التام على خصوصية المشاهدين."
    },
    {
